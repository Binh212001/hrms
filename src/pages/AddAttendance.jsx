...
function AddAtendance() {
  ...
  return (
    <div className="p-4">
      <div>
        <Button type="button" className="bg-green-500 border-none mr-6" onClick={() => handelAtd()}>
          Save
        </Button>
      </div>
      <h3 className="text-xl mt-3">{id ? "Update " : "New "} Attendance</h3>
